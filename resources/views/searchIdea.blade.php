        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              <h1 class="page-title">Résultats des idées recherchées</h1>
              <ol class="breadcrumb">
                <li><a href="/acceuil">acceuil</a></li>
                <li><a href="/idees">Acceuil</a></li>
     ...
     @foreach ($filtre as $res)
        ...
        <div class="full">
          ...
          <div class="service_cont">
            ...
            <div class="bt_cont"> <a class="btn sqaure_bt" href="{{ url('/idee/'.$res->id) }}">Voir l'idée</a> </div>
          </div>
        </div>
      </div>
